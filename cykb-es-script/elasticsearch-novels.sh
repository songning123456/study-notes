...
delIndex()
{
	curl -H "Content-Type: application/json" -XDELETE -i -s "$1/novels_index" > /dev/null
	echo "delete index novels_index successfully !"

}

createIndex()
{
  curl -H "Content-Type: application/json" -XPUT -i -s $1/novels_index -d '
	{
	  "settings": {
	...
	echo " create novels_index successfully !"
