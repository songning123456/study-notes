...
delIndex()
{
	curl -H "Content-Type: application/json" -XDELETE -i -s "$1/comments_index" > /dev/null
	echo "delete index comments_index successfully !"

}

createIndex()
{
  curl -H "Content-Type: application/json" -XPUT -i -s $1/comments_index -d '
	{
	  "settings": {
	...
	echo " create comments_index successfully !"
