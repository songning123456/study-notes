...
delIndex()
{
	curl -H "Content-Type: application/json" -XDELETE -i -s "$1/users_index" > /dev/null
	echo "delete index users_index successfully !"

}

createIndex()
{
  curl -H "Content-Type: application/json" -XPUT -i -s $1/users_index -d '
	{
	  "settings": {
	...
	echo " create users_index successfully !"
